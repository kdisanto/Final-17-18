...
public class AutoBlueStraightColor extends LinearOpMode {
    ...
    static final double s1_RIGHT = 27;
    static final double s1_LEFT = -27;
    ...
    static final double s4_TURN = -21.5;
    ...
    static final double s6_RIGHT = 1.5;
    static final double s6_LEFT = -1.5;
